        ...
        <div className='p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-4'>
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Image src="https://images.pexels.com/photos/32838310/pexels-photo-32838310.jpeg" alt="" height={40} width={40} className="w-10 h-10 rounded-full object-cover" />
                    <span className="font-semibold">Mars Brus</span>
                </div>
